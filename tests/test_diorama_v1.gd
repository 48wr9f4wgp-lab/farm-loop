...
func _init() -> void:
    ...
    diorama.custom_minimum_size = Vector2(390,430)
    ...
    _ok(facilities.has("coop") and facilities.has("compost") and facilities.has("sansai") and facilities.has("mushroom") and facilities.has("bee"),"all proof facilities exist in 3D")
