class_name FarmScreenV15
extends "res://scripts/ui/screens/farm_screen_v14.gd"

const FarmDioramaV15Class = preload("res://scripts/ui/farm_diorama_v15.gd")

func _build_map(host) -> void:
    var farm_map = FarmDioramaV15Class.new()
