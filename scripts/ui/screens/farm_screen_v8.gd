class_name FarmScreenV8
extends "res://scripts/ui/screens/farm_screen_v7.gd"

const FarmDioramaV8Class = preload("res://scripts/ui/farm_diorama_v8.gd")

func _build_map(host) -> void:
    var farm_map = FarmDioramaV8Class.new()
