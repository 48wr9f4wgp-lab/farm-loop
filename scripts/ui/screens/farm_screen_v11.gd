class_name FarmScreenV11
extends "res://scripts/ui/screens/farm_screen_v10.gd"

const FarmDioramaV11Class = preload("res://scripts/ui/farm_diorama_v11.gd")

func _build_map(host) -> void:
    var farm_map = FarmDioramaV11Class.new()
