class_name FarmScreenV12
extends "res://scripts/ui/screens/farm_screen_v11.gd"

const FarmDioramaV12Class = preload("res://scripts/ui/farm_diorama_v12.gd")

func _build_map(host) -> void:
    var farm_map = FarmDioramaV12Class.new()
