class_name FarmScreenV14
extends "res://scripts/ui/screens/farm_screen_v13.gd"

const FarmDioramaV14Class = preload("res://scripts/ui/farm_diorama_v14.gd")

func _build_map(host) -> void:
    var farm_map = FarmDioramaV14Class.new()
