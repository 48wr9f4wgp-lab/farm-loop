class_name FarmScreenV10
extends "res://scripts/ui/screens/farm_screen_v9.gd"

const FarmDioramaV10Class = preload("res://scripts/ui/farm_diorama_v10.gd")

func _build_map(host) -> void:
    var farm_map = FarmDioramaV10Class.new()
